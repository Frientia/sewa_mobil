...
// Ambil total mobil
$query_mobil = mysqli_query($koneksi, "SELECT COUNT(*) AS total_mobil FROM mobil");
$data_mobil = mysqli_fetch_assoc($query_mobil);

// Ambil total supir
$query_supir = mysqli_query($koneksi, "SELECT COUNT(*) AS total_supir FROM supir");
$data_supir = mysqli_fetch_assoc($query_supir);

// Ambil total user
$query_user = mysqli_query($koneksi, "SELECT COUNT(*) AS total_user FROM users");
...
$query_penyewaan_bulan_ini = mysqli_query($koneksi, "SELECT COUNT(*) AS total_penyewaan_bulan_ini FROM penyewaan 
...
$queryBalance = mysqli_query($koneksi, "SELECT IFNULL(SUM(jumlah_bayar), 0) AS total_balance FROM pembayaran WHERE status_pembayaran='terkonfirmasi'");
