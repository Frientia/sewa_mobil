    ...
    <div class="sidebar">
        <div>
            ...
            <nav>
                ...
                <a href="data_supir.html"><i class="fas fa-user-tie"></i>Data Supir</a>
                <a href="data_pengguna.html" class="active"><i class="fas fa-users"></i>Data Pengguna</a>
